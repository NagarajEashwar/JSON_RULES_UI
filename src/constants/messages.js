...
const NO_DECISION_HEADER = 'No Conditions';
const NO_DECISION_BODY = 'There is no Conditions available in the selected ruleset.'
const BUTTON_PROPS_DECISION = {label: 'Create Conditions'};
...
const NO_VALIDATION_BODY = 'There is no Conditions available in the selected ruleset to validate.'
...
export const WORKFLOW_FIELD_NAME_VALUE_DICTIONARY = [{
